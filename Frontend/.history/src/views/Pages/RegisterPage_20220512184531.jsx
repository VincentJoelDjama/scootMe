...
class RegisterPage extends React.Component {
  ...
  register = async e => {
    ...
    const fields = ["firstname", "lastname", "email", "password", "mobile", "address", "picture"];
            ...
            <form onSubmit={this.register}>
              <Card className={classes[this.state.cardAnimaton]}>
                ...
                <CardBody>
                  ...
                  />
                  <CardBody>
                    <p className={classescardDescription}>Or Be Classical</p>
                    <costomInput 
                    labelText="LastName..."
                    id="lastname"
                    formControlProps={{
                    ...
                    inputProps={{
                      ...
                      enndAdornment:(
                        <inputAdornment position="end">
                          <Face className={classes.inputAdornment} />
                          </inputAdornment>
                      )
                    }}
                    />
